      ...
      <View style={{flex:1, zIndex:-100,backgroundColor: this.props.contentBackgroundColor}}>
        <Animated.View style={{ height: animateHeight, backgroundColor: this.props.refreshBackgroundColor, overflow: 'hidden' }}>
          <View style={{flex: 1, alignSelf: 'center', justifyContent: 'center', height: '100%'}}>
            <Image source={this.props.spinner} style={[{flex: 1, alignSelf: 'center', maxHeight: this.props.spinnerMaxHeight, margin: this.props.margin}, !this.props.isRefreshing && this.props.isRefreshingComplete  ? { display: 'none' } : {}]} resizeMode={'contain'} />
            <Image source={this.props.arrow} style={[{flex: 1, alignSelf: 'center', maxHeight: this.props.arrowMaxHeight, margin: this.props.margin}, this.props.isRefreshing || !this.props.isRefreshingComplete ? { display: 'none' } : {}]} resizeMode={'contain'} />
          </View>
        </Animated.View>
